...
/* Fichier de langue français UTF-8 pour AmazonLinks 1.1.0 */
...
$LANG_AMAZONLINKS = array(
    ...
    'legacy_warning' => 'Ce site utilise encore AmazonLinks 1.0. Les fichiers 1.1 continuent à lire temporairement son ancien fichier de configuration en mode de compatibilité, sans le modifier. Lancez la mise à jour du plugin sur ce site lorsque vous êtes prêt ; le tag, le titre, le nombre maximal de liens et les règles seront alors migrés automatiquement.',
    'installed_version' => 'Version installée sur ce site',
    'legacy_file' => 'Configuration AmazonLinks 1.0',
    'legacy_admin_unavailable' => 'AmazonLinks 1.0 ne possédait ni page d’administration ni configuration en ligne. La nouvelle administration 1.1 sera disponible uniquement après la mise à jour explicite de ce site. Les liens existants continuent de fonctionner avec la configuration historique jusque-là.',
