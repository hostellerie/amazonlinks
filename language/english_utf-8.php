...
/* English UTF-8 language file for AmazonLinks 1.1.0 */
...
$LANG_AMAZONLINKS = array(
    ...
    'legacy_warning' => 'This site is still using AmazonLinks 1.0. The 1.1 files temporarily continue to read its legacy configuration file through a compatibility path without modifying it. Run the plugin upgrade on this site when ready; the affiliate tag, title, maximum links and contextual rules will then be migrated automatically.',
    'installed_version' => 'Installed version on this site',
    'legacy_file' => 'AmazonLinks 1.0 configuration',
    'legacy_admin_unavailable' => 'AmazonLinks 1.0 did not provide a web administration page or online configuration. The new 1.1 administration becomes available only after this site completes its explicit plugin upgrade. Existing links continue to use the historical configuration until then.',
